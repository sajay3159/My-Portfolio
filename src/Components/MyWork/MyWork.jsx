...
const MyWork = () => {
  ...
  const handleShowMore = () => {
    setVisibleProjects((prev) => Math.min(prev + 3, mywork_data.length));
  };
  ...
  const allProjectsVisible = visibleProjects >= mywork_data.length;
  ...
  return (
    <div id="mywork" className="mywork">
      ...
      <div className="mywork-buttons">
        {/* Show More button only if there are hidden projects */}
        {!allProjectsVisible && (
        ...
        {/* Show Less button only when all projects are visible */}
